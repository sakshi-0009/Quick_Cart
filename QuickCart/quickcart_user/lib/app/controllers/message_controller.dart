...
final class MessageController extends GetxController implements Bootable {
  ...
  void _handleStreamGroupChat() async {
    ...
    final groupChatId = currentUser!.uid;
  ...
  Future<Either<Failure, void>> sendMessage(
    ...
    if (receiverUser == null) return left(const Failure.custom('receiverUser is null'));
  ...
  Future<Either<Failure, void>> _sendMessage(
    ...
    if (receiverUser.playerIds.isEmpty) return left(const Failure.custom('playerIds is empty'));
    try {
