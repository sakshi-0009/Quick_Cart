...
import '../../controller/add_product_item_controller.dart';

class AdminAddProductMobileView
    extends GetView<AdminAddProductScreenController> {
  const AdminAddProductMobileView({Key? key}) : super(key: key);
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      TextInputTitle(
                          title: 'Product_Add_Price'.tr, paddingLeft: AppGapSize.none),
                      Expanded(
                        child: AppPadding(
                          padding: const AppEdgeInsets.only(
                ...
                TextInputTitle(
                    title: 'Product_Detail_Add_Title'.tr,
                    paddingLeft: AppGapSize.none),
                AppTextFormField(
                    hintText: 'Product_Detail_Add_Title'.tr,
                    textStyle: textStyle,
                    maxLines: null,
                    decoration: _decoration(
                    ...
                    child: Obx(() {
                      return Center(
                        child: controller.loading.value
                            ...
                            : AppButton.max(
                          title: 'Product_Add_Title'.tr,
                          onPressed: () => controller.onPressedAddMenuItem(),
                        ),
                      );
                    }),
                  ),
