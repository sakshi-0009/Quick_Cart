...
class ChatMessageVideo extends StatefulWidget {
  ...
  const ChatMessageVideo({super.key, required this.messageChat, required this.timestamp});
  ...
  void _asyncInit() async {
    ...
    _controller.addListener(() {
      ...
      if (_controller.value.isInitialized && _controller.value.isPlaying) {
        ...
        _pauseButtonTimer = Timer(const Duration(seconds: 1), () {
          if (!mounted) return;
          setState(() {
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: const Icon(Icons.pause, color: ThemeColors.textDarkColor, size: kToolbarHeight / 1.5),
                      ),
                    ),
                    if (!isPlaying)
                      GestureDetector(
                        onTap: () => _controller.play(),
                        child: const Icon(Icons.play_arrow, color: ThemeColors.textDarkColor, size: kToolbarHeight / 1.5),
                      ),
                    //Download icon
                    Positioned(
                      right: 8,
                      ...
                      child: GestureDetector(
                        ...
                        child: const Icon(Icons.file_download, color: ThemeColors.textDarkColor, size: kToolbarHeight / 2),
                      ),
                    ),
                  ],
                )
