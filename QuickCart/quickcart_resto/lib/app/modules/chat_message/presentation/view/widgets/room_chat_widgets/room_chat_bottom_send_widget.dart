            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(16),
                    borderSide: BorderSide(color: Theme.of(context).colorScheme.primary)),
                prefixIcon: listFile.isEmpty ? const SizedBox(width: kToolbarHeight, height: kToolbarHeight) : null,
                suffixIcon: InkWell(
                  onTap: () => controller.onSendMessage(),
                  child: const AppPadding.medium(child: AppIcons.sendMessage()),
                ),
              ),
            ),
          ),
              ...
              : Container(
                  ...
                  child: Wrap(crossAxisAlignment: WrapCrossAlignment.start, children: [
                    ...
                    Obx(() {
                      ...
                      if (selectChatFiles is !SelectChatImages) return const SizedBox.shrink();
