...
class ChatMessageText extends StatelessWidget {
  ...
  const ChatMessageText({super.key, required this.message, required this.timestamp});
      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: AppPadding(
              padding: const AppEdgeInsets.only(right: AppGapSize.small, bottom: AppGapSize.small),
