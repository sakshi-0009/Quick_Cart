...
import 'package:quickcart_resto/app/modules/auth/controller/onboard_controller.dart';
          ...
          itemBuilder: (context, index) {
            ...
            return Column(
              ...
              children: [
                ...
                AppPadding.medium(
                    padding: const AppEdgeInsets.symmetric(vertical: AppGapSize.medium, horizontal: AppGapSize.large),
