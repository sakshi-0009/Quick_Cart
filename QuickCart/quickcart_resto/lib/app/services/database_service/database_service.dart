...
class DatabaseService extends GetxService
  ...
  Future<Either<Failure, CategoryModel>> addCategory(
    ...
    try {
      await _db
          .collection(DatabaseKeys.categoryPath)
          .doc(id.toString())
  ...
  Future<Either<Failure, String>> deleteCategory(int categoryId) async {
    try {
      await _db
          .collection(DatabaseKeys.categoryPath)
  ...
  Future<Either<Failure, ProductModel>> addProductToCategory(
      ProductModel productModel, int id, int categoryId) async {
    try {
      await _db
          .collection(DatabaseKeys.productPath)
          .doc(id.toString())
  ...
  Future<Either<Failure, String>> deleteProductFromCategory(
      int productId) async {
    var categoryId;
    try {
      await _db
        ...
        for (var v in value.docs) {
          var docMap = v.data() as Map;
          categoryId = docMap['id'];
        }
      });
      await _db
          .collection(DatabaseKeys.categoryPath)
