...
final class UserController extends GetxController implements Bootable {
  ...
  Future<Either<Failure, void>> updateUser(
    ...
    if (_currentUser == null) return left(const Failure.custom('User is null'));
    try {
...
// Comment Product
  ...
  Future<Either<Failure, void>> sendDeliveryNotificationToRestaurant(OrderModel orderModel) async {
    ...
    if (restaurantProfile == null) return left(const Failure.custom('Restaurant profile is null'));

    final content = orderModel.status == HistoryStatus.request ? 'Notification_Request' : 'Notification_Done';
    ...
    try {
      ...
      final OSCreateNotification notification = OSCreateNotification(
          ...
          content: content,
          heading: "Code_Order" ": ${orderModel.createdAt}",
